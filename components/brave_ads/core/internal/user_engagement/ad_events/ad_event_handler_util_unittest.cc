...
TEST_F(BraveAdsAdEventHandlerUtilTest,
  ...
  AdvanceClockBy(kDebounceViewedAdEventWithinTimeWindow.Get());
...
TEST_F(BraveAdsAdEventHandlerUtilTest, ShouldNeverDebounceViewedAdEvent) {
  // Arrange
  base::test::ScopedFeatureList scoped_feature_list;
  scoped_feature_list.InitAndEnableFeatureWithParameters(
      kAdEventFeature, {{"debounce_viewed_ad_event_within_time_window", "0s"}});
...
TEST_F(BraveAdsAdEventHandlerUtilTest,
  ...
  AdvanceClockBy(kDebounceClickedAdEventWithinTimeWindow.Get());
...
TEST_F(BraveAdsAdEventHandlerUtilTest, ShouldNeverDebounceClickedAdEvent) {
  // Arrange
  base::test::ScopedFeatureList scoped_feature_list;
  scoped_feature_list.InitAndEnableFeatureWithParameters(
      kAdEventFeature,
      {{"debounce_clicked_ad_event_within_time_window", "0s"}});
