...
inline constexpr base::FeatureParam<base::TimeDelta>
    kDebounceViewedAdEventWithinTimeWindow{
        &kAdEventFeature, "debounce_viewed_ad_event_within_time_window",
        base::Seconds(0)};

// Set to 0 to always debounce clicked ad events.
inline constexpr base::FeatureParam<base::TimeDelta>
    kDebounceClickedAdEventWithinTimeWindow{
        &kAdEventFeature, "debounce_clicked_ad_event_within_time_window",
        base::Seconds(0)};
