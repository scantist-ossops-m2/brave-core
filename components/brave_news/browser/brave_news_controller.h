...
class BraveNewsController
 ...
 private:
  ...
  // preferences is ensured. This happens after first opt-in and after locales
  // and channels are fetched. A valid feed and list of channels might only be
  // available after this event has fired. If News is already enabled and this
  // event has already signalled, then they are already available.
