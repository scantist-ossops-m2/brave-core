...
inline constexpr webui::LocalizedString kLocalizedStrings[] = {
    ...
    {"braveWalletAutoLockDurationFiveMinutes",
     IDS_BRAVE_WALLET_AUTO_LOCK_DURATION_FIVE_MINUTES},
    {"braveWalletAutoLockDurationTenMinutes",
     IDS_BRAVE_WALLET_AUTO_LOCK_DURATION_TEN_MINUTES},
    {"braveWalletAutoLockDurationOneHour",
     IDS_BRAVE_WALLET_AUTO_LOCK_DURATION_ONE_HOUR},
    {"braveWalletAutoLockDurationThreeHours",
     IDS_BRAVE_WALLET_AUTO_LOCK_DURATION_THREE_HOURS},
