...
inline constexpr webui::LocalizedString kLocalizedStrings[] = {
    ...
    {"braveWalletWelcomeNewWalletTitle", IDS_BRAVE_WALLET_WELCOME_NEW_WALLET_TITLE},
    {"braveWalletWelcomeNewWalletDescription", IDS_BRAVE_WALLET_WELCOME_NEW_WALLET_DESCRIPTION},
    {"braveWalletWelcomeImportWalletTitle", IDS_BRAVE_WALLET_WELCOME_IMPORT_WALLET_TITLE},
    {"braveWalletWelcomeImportWalletDescription", IDS_BRAVE_WALLET_WELCOME_IMPORT_WALLET_DESCRIPTION},
    {"braveWalletWelcomeWatchOnlyTitle", IDS_BRAVE_WALLET_WELCOME_WATCH_ONLY_TITLE},
    {"braveWalletWelcomeCopyright", IDS_BRAVE_WALLET_WELCOME_COPYRIGHT},
    ...
    {"braveWalletAutoLockDurationFiveMinutes", IDS_BRAVE_WALLET_AUTO_LOCK_DURATION_FIVE_MINUTES},
    {"braveWalletAutoLockDurationTenMinutes", IDS_BRAVE_WALLET_AUTO_LOCK_DURATION_TEN_MINUTES},
    {"braveWalletAutoLockDurationOneHour", IDS_BRAVE_WALLET_AUTO_LOCK_DURATION_ONE_HOUR},
    {"braveWalletAutoLockDurationThreeHours", IDS_BRAVE_WALLET_AUTO_LOCK_DURATION_THREE_HOURS},
