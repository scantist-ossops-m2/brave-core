...
inline constexpr webui::LocalizedString kLocalizedStrings[] = {
    ...
    {"braveWalletImportWalletTypeHotWalletTitle", IDS_BRAVE_WALLET_IMPORT_WALLET_TYPE_HARDWARE_WALLET_TITLE},
    {"braveWalletImportWalletTypeHotWalletDescription", IDS_BRAVE_WALLET_IMPORT_WALLET_TYPE_HARDWARE_WALLET_DESCRIPTION},
