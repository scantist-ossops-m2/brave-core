...
inline constexpr webui::LocalizedString kLocalizedStrings[] = {
    ...
    {"braveWalletImportWalletTypeTitle", IDS_BRAVE_WALLET_IMPORT_WALLET_TYPE_TITLE},
    {"braveWalletImportWalletTypeHotWalletTitle", IDS_BRAVE_WALLET_IMPORT_WALLET_TYPE_HOT_WALLET_TITLE},
    {"braveWalletImportWalletTypeHotWalletDescription", IDS_BRAVE_WALLET_IMPORT_WALLET_TYPE_HOT_WALLET_DESCRIPTION},
    {"braveWalletImportWalletTypeHardwareWalletTitle", IDS_BRAVE_WALLET_IMPORT_WALLET_TYPE_HARDWARE_WALLET_TITLE},
    {"braveWalletImportWalletTypeHardwareWalletDescription", IDS_BRAVE_WALLET_IMPORT_WALLET_TYPE_HARDWARE_WALLET_DESCRIPTION},
    ...
    {"braveWalletAuthorizeHardwareWallet", IDS_BRAVE_WALLET_AUTHORIZE_HARDWARE_WALLET},
    {"braveWalletConnectHardwareWallet", IDS_BRAVE_WALLET_CONNECT_HARDWARE_WALLET},
    {"braveWallectConnectHardwareDescription", IDS_BRAVE_WALLET_CONNECT_HARDWARE_WALLET_DESCRIPTION},
    {"braveWalletImportHardwareWalletDescription", IDS_BRAVE_WALLET_IMPORT_HARDWARE_WALLET_DESCRIPTION},
    {"braveWalletConnectHardwareWalletSelectBlockchain", IDS_BRAVE_WALLET_CONNECT_HARDWARE_WALLET_SELECT_BLOCKCHAIN},
    {
    ...
    {"braveWalletRecoveryPhraseBackupWarningImportant",
     ...
     {"braveWalletVerifyRecoveryPhraseGoBack", IDS_BRAVE_WALLET_VERIFY_RECOVERY_PHRASE_GO_BACK},
    ...
    {"braveWalletImportWithRecoveryPhrase", IDS_BRAVE_WALLET_IMPORT_WITH_RECOVERY_PHRASE},
    {"braveWalletMetamaskDetected", IDS_BRAVE_WALLET_METAMASK_DETECTED},
    {"braveWalletMetamaskImportUsePassword", IDS_BRAVE_WALLET_METAMASK_IMPORT_USE_PASSWORD},
