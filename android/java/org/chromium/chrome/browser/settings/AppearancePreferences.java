...
public class AppearancePreferences extends BravePreferenceFragment
    ...
    public static final String PREF_ENABLE_WINDOWS = "enable_windows";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!shouldShowEnableWindow()) {
            removePreferenceIfPresent(PREF_ENABLE_WINDOWS);
        }
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Preference enableWindow = findPreference(PREF_ENABLE_WINDOWS);
        if (enableWindow != null) {
            enableWindow.setOnPreferenceChangeListener(this);
            if (enableWindow instanceof ChromeSwitchPreference) {
                ((ChromeSwitchPreference) enableWindow)
                        .setChecked(BraveMultiWindowUtils.shouldEnableWindows());
            }
        }
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (BravePreferenceKeys.BRAVE_BOTTOM_TOOLBAR_ENABLED_KEY.equals(key)) {
            ...
            shouldRelaunch = true;
        } else if (PREF_ENABLE_WINDOWS.equals(key)) {
            if (!(boolean) newValue) {
                                ...
                                public void onDismiss() {
                                    if (MultiWindowUtils.getInstanceCount() == 1) {
                                        if (preference instanceof ChromeSwitchPreference) {
                                            ...
                                            BraveMultiWindowUtils.updateEnableWindows(false);
                                        }
                                    }
                                }
                            };
            ...
            BraveMultiWindowUtils.updateEnableWindows((boolean) newValue);
        }
        if (shouldRelaunch) {
